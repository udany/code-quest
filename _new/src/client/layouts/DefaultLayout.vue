		...
		<div class="cq-header">
			<div class="container">
				<div class="row">
					...
					<div class="col login-info text-end" v-if="session.user">
					...
					<div class="col login-info text-end" v-else>
						<button class="btn btn-light btn-sm" @click="loginPage">Login</button>
					</div>
				</div>
			</div>
		</div>
